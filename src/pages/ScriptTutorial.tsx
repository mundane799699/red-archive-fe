...
import styles from "./ScriptTutorial.module.scss";
    ...
    <div className={styles.outer}>
      <div className={styles.container}>
        ...
        <div className={styles.mb}>
          ...
          <Image width={1200} src={"https://cdn.mundane.ink/202403272108495.png"} />
        </div>
        <div className={styles.mb}>
          <Title>3、打开小红书网页版, 切换至收藏tab</Title>
          <Title level={3}>右上角如果出现图中所示的两个按钮, 说明小红书转发脚本已生效</Title>
          <Image width={1200} src={"https://cdn.mundane.ink/202403272130053.png"} />
        </div>
        <div className={styles.mb}>
          ...
          <Image width={1200} src={"https://cdn.mundane.ink/202403272134315.png"} />
        </div>
        <div className={styles.mb}>
          <Title>5、等待滚动完成</Title>
          <Title level={3}>
            等滚动到页面最底部或者出现图中所示的提示框以后, 所有收藏数据已转发完成
          </Title>
          <Image width={1200} src={"https://cdn.mundane.ink/202403272139223.png"} />
        </div>
        <div className={styles.mb}>
          <Title>6、点击去下载按钮</Title>
          <Title level={3}>点击"去下载"按钮后, 页面会自动跳转至小红书收藏导出网站</Title>
          <Image src={"https://cdn.mundane.ink/202403272144051.png"} />
          <Title level={3}>或者复制地址栏中的userId, 然后手动转到xhs.mundane.ink</Title>
          <Title level={3}>如图中5f827ea10000000001007b5b就是我的userId, 这个很重要</Title>
        ...
        <div className={styles.mb}>
          ...
          <Image width={1200} src={"https://cdn.mundane.ink/202403272152824.png"} />
        </div>
        <div className={styles.mb}>
          ...
          <Image width={1200} src={"https://cdn.mundane.ink/202403272207566.png"} />
        </div>
        <div className={styles.mb}>
